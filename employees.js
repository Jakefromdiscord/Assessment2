...
class Employee {
    ...
    getSchedule(){
        return `${this.name} works ${this.shift}`
    }
}
...
const empOne = new Employee('Jess', 'weekday mornings, weekday afternoos')
...
//CODE HERE
console.log(manager.getEmployess())
