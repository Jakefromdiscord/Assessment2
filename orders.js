...
class Ticket{
    ...
    updateStatus(newStatus){
        ...
        return `the order for customer ${this.customer} is ${this.status} `
    }
}

const property = 'queued'

const newTick = new Ticket('food', 30, 112)

console.log(newTick.updateStatus(15))
